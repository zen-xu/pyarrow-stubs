...
class Table(_PandasConvertible):
    ...
    @staticmethod
    def from_arrays(arrays: list[Array], names: list[str] | None = None, schema: Schema | None = None, metadata: dict[str | bytes, str | bytes] | None = None) -> Table: ...
    @staticmethod
    def from_batches(batches: collections.abc.Iterable[RecordBatch], schema: Schema | None = None) -> Table: ...
    @classmethod
    def from_pandas(
        cls,
        df: pd.DataFrame,
