...
class Array(_PandasConvertibleToSeries, Generic[_T, _Scalar]):
    ...
    def _to_pandas(
        ...
        types_mapper: Callable[[DataType], pd.api.extensions.ExtensionDtype | None] | None = ...,
        **kwargs,
    ) -> pd.Series: ...
    ...
    def cast(
        self,
        target_type: Literal["timestamp[s]", "timestamp[ms]", "timestamp[us]", "timestamp[ns]"],
        safe: bool = ...,
        options: CastOptions = ...,
    ) -> TimestampArray: ...
    @overload
    def cast(
        self,
        target_type: Literal["duration[s]", "duration[ms]", "duration[us]", "duration[ns]"],
        safe: bool = ...,
        options: CastOptions = ...,
    ) -> DurationArray: ...
    @overload
    ...
    def take(
        self: _Array,
        indices: list[int] | IntegerArray | NDArray[np.signedinteger | np.unsignedinteger],
    ) -> _Array: ...
    ...
    @overload
    def view(self, target_type: Literal["f2", "halffloat", "float16"]) -> HalfFloatArray: ...
    @overload
...
class ChunkedArray(_PandasConvertibleToSeries, Generic[_T, _Scalar]):
    ...
    def combine_chunks(self, memory_pool: MemoryPool | None = ...) -> Array[_T, _Scalar]: ...
    def dictionary_encode(self: _ChunkedArray, null_encoding: str = ...) -> _ChunkedArray: ...
    ...
    def flatten(self: _ChunkedArray, memory_pool: MemoryPool | None = ...) -> _ChunkedArray: ...
...
class ExtensionScalar(Scalar[_T]):
    value: Scalar[_T]
    @staticmethod
    def from_storage(self, typ: BaseExtensionType[_T], value: object) -> ExtensionScalar[_T]: ...
...
class MapArray(ListArray[dict[_Key, _Item], MapScalar, StructArray], Generic[_Key, _Item]):
...
class Message(_Weakrefable):
    ...
    def serialize(self, alignment: int = ..., memory_pool: MemoryPool | None = ...) -> Any: ...
    def serialize_to(
        self,
        sink: NativeFile,
        alignment: int = ...,
...
class Scalar(_Weakrefable, Generic[_T]):
    ...
    @overload
    def cast(self, target_type: Literal["time64[us]", "time64[ns]"]) -> Time64Scalar: ...
    @overload
    def cast(
        self,
        target_type: Literal["timestamp[s]", "timestamp[ms]", "timestamp[us]", "timestamp[ns]"],
...
class Schema(_Weakrefable):
    ...
    def add_metadata(self: _Self, metadata: dict[str | bytes, str | bytes]) -> _Self: ...
    ...
    @classmethod
    def from_pandas(cls, df: pd.DataFrame, preserve_index: bool | None = ...) -> Schema: ...
    ...
    def with_metadata(self: _Self, metadata: dict[str | bytes, str | bytes]) -> _Self: ...
    def __eq__(self, other) -> bool: ...
...
class SparseCOOTensor(_Weakrefable, Generic[_T]):
    ...
    @staticmethod
    def from_pydata_sparse(obj, dim_names: list[str] | None = ...) -> SparseCOOTensor: ...
    @staticmethod
...
class SparseCSFTensor(_Weakrefable, Generic[_T]):
    ...
    @staticmethod
    def from_dense_numpy(obj: NDArray, dim_names: list[str] | None = ...) -> SparseCSFTensor: ...
    @staticmethod
    def from_numpy(
        data: NDArray,
        indptr: NDArray,
...
class Table(_PandasConvertibleToDataFrame):
    ...
    def add_column(self: _Self, i: int, field_: str | Field, column: Array) -> _Self: ...
    ...
    def set_column(self: _Self, i: int, field_: str | Field, column: Array) -> _Self: ...
    def slice(self: _Self, offset: int = ..., length: int | None = ...) -> _Self: ...
    def sort_by(
        self,
    ...
    def to_string(self, *, show_metadata: bool = ..., preview_cols: int = ...) -> str: ...
    def unify_dictionaries(self: _Self, memory_pool: MemoryPool | None = ...) -> _Self: ...
    def validate(self, *, full: bool = ...) -> None: ...
    def __eq__(self, other) -> bool: ...
    @overload
...
@overload
def chunked_array(arrays: Array, type: DataType[_T]) -> ChunkedArray[_T, Scalar[_T]]: ...
@overload
def compress(
    buf: Buffer | bytes | memoryview,
    codec: str = ...,
...
def concat_arrays(arrays: list[_Array], memory_pool: MemoryPool | None = ...) -> _Array: ...
def concat_tables(
...
def deserialize_components(components: dict, context: SerializationContext = ...) -> object: ...
...
def list_(value_type: DataType[_T] | Field[_T], list_size: int = ...) -> ListType[_T]: ...
...
@overload
def table(df: pd.DataFrame, schema: Schema | None = ..., nthreads: int | None = ...) -> Table: ...
@overload
def table(data: RecordBatch, schema: Schema | None = ..., nthreads: int | None = ...) -> Table: ...
@overload
def table(
    arrays: list[Array],
    schema: Schema,
