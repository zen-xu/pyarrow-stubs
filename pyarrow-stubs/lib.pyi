...
class NativeFile(_Weakrefable):
    ...
    def close(self) -> None: ...
    def download(
        self, stream_or_path: str | IOBase, buffer_size: int | None = ...
    ) -> None: ...
    def fileno(self) -> int: ...
    def flush(self) -> None: ...
    ...
    def upload(self, stream: IOBase, buffer_size: int = ...) -> None: ...
...
def foreign_buffer(address: int, size: int, base: object | None = ...) -> None: ...
...
def read_message(source: NativeFile | IOBase | Buffer) -> Message: ...
