...
@overload
def asarray(values: Iterable[int]) -> Int64Array: ...
@overload
def asarray(values: Iterable[float]) -> DoubleArray: ...
@overload
def asarray(values: Iterable[Decimal]) -> Decimal128Array: ...
@overload
def asarray(values: Iterable[dict[str, Any]]) -> StructArray: ...
@overload
def asarray(values: Iterable[dt.date]) -> Date32Array: ...
@overload
def asarray(values: Iterable[dt.time]) -> Time64Array: ...
@overload
def asarray(values: Iterable[dt.timedelta]) -> DurationArray: ...
@overload
def asarray(values: Iterable[MonthDayNano]) -> MonthDayNanoIntervalArray: ...
@overload
def asarray(values: Iterable[list]) -> ListArray: ...
@overload
def asarray(values: Iterable, type: _DataTypeT) -> Array[Scalar[_DataTypeT]]: ...
@overload
def asarray(values: Iterable, type: Literal["null"]) -> Array[scalar.NullScalar]]: ...
@overload
def asarray(
    values: Iterable, type: Literal["bool", "boolean"]
) -> Array[scalar.BooleanScalar]: ...
@overload
def asarray(values: Iterable, type: Literal["i1", "int8"]) -> Array[scalar.Int8Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["i2", "int16"]) -> Array[scalar.Int16Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["i4", "int32"]) -> Array[scalar.Int32Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["i8", "int64"]) -> Array[scalar.Int64Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["u1", "uint8"]) -> Array[scalar.UInt8Scalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["u2", "uint16"]
) -> Array[scalar.UInt16Scalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["u4", "uint32"]
) -> Array[scalar.UInt32Scalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["u8", "uint64"]
) -> Array[scalar.UInt64Scalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["f2", "halffloat", "float16"]
) -> Array[scalar.HalfFloatScalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["f4", "float", "float32"]
) -> Array[scalar.FloatScalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["f8", "double", "float64"]
) -> Array[scalar.DoubleScalar]: ...
@overload
def asarray(
    values: Iterable, type: Literal["string", "str", "utf8"]
) -> Array[scalar.StringScalar]: ...
@overload
def asarray(values: Iterable, type: Literal["binary"]) -> Array[scalar.BinaryScalar]: ...
@overload
def asarray(
    values: Iterable,
...
@overload
def asarray(values: Iterable, type: Literal["large_binary"]) -> Array[scalar.LargeBinaryScalar]: ...
@overload
def asarray(values: Iterable, type: Literal["binary_view"]) -> Array[scalar.BinaryViewScalar]: ...
@overload
def asarray(values: Iterable, type: Literal["string_view"]) -> Array[scalar.StringViewScalar]: ...
@overload
def asarray(values: Iterable, type: Literal["date32", "date32[day]"]) -> Array[scalar.Date32Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["date64", "date64[ms]"]) -> Array[scalar.Date64Scalar]: ...
@overload
def asarray(values: Iterable, type: Literal["time32[s]"]) -> Array[scalar.Time32Scalar[Literal['s']]]: ...
@overload
def asarray(values: Iterable, type: Literal["time32[ms]"]) -> Array[scalar.Time32Scalar[Literal['ms']]]: ...
@overload
def asarray(values: Iterable, type: Literal["time64[us]"]) -> Array[scalar.Time64Scalar[Literal['us']]]: ...
@overload
def asarray(values: Iterable, type: Literal["time64[ns]"]) -> Array[scalar.Time64Scalar[Literal['ns']]]: ...
@overload
def asarray(values: Iterable, type: Literal["timestamp[s]"]) -> Array[scalar.TimestampScalar[Literal['s']]]: ...
@overload
def asarray(values: Iterable, type: Literal["timestamp[ms]"]) -> Array[scalar.TimestampScalar[Literal['ms']]]: ...
@overload
def asarray(values: Iterable, type: Literal["timestamp[us]"]) -> Array[scalar.TimestampScalar[Literal['us']]]: ...
@overload
def asarray(values: Iterable, type: Literal["timestamp[ns]"]) -> Array[scalar.TimestampScalar[Literal['ns']]]: ...
@overload
def asarray(values: Iterable, type: Literal["duration[s]"]) -> Array[scalar.DurationScalar[Literal['s']]]: ...
@overload
def asarray(values: Iterable, type: Literal["duration[ms]"]) -> Array[scalar.DurationScalar[Literal['ms']]]: ...
@overload
def asarray(values: Iterable, type: Literal["duration[us]"]) -> Array[scalar.DurationScalar[Literal['us']]]: ...
@overload
def asarray(values: Iterable, type: Literal["duration[ns]"]) -> Array[scalar.DurationScalar[Literal['ns']]]: ...
@overload
def asarray(values: Iterable, type: Literal["month_day_nano_interval"]) -> Array[scalar.MonthDayNanoIntervalScalar]: ...
@overload
