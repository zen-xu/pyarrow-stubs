...
@overload
def chunked_array(
    values: Iterable[dt.datetime] | Iterable[dt.date],
    type: None = None,
) -> ChunkedArray[scalar.TimestampScalar] | ChunkedArray[scalar.Date32Scalar]: ...
@overload
def chunked_array(
...
class RecordBatch(_Tabular[Array]):
    ...
    def select(self, columns: Iterable[str] | NDArray[np.str_] | Indices) -> Self: ...
    def cast(
