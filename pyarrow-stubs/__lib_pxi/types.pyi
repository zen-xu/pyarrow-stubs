...
class LargeListType(DataType, Generic[_DataType_CoT]):
    @property
    def value_field(self) -> Field[_DataType_CoT]: ...
    @property
    def value_type(self) -> _DataType_CoT: ...

class ListViewType(DataType, Generic[_DataType_CoT]):
    @property
    def value_field(self) -> Field[_DataType_CoT]: ...
    @property
    def value_type(self) -> _DataType_CoT: ...

class LargeListViewType(DataType, Generic[_DataType_CoT]):
    @property
    def value_field(self) -> Field[_DataType_CoT]: ...
    @property
    def value_type(self) -> _DataType_CoT: ...

class FixedSizeListType(DataType, Generic[_DataType_CoT, _Size]):
    @property
    def value_field(self) -> Field[_DataType_CoT]: ...
    @property
    def value_type(self) -> _DataType_CoT: ...
