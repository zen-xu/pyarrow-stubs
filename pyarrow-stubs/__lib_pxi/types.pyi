...
class Field(_Weakrefable):
    ...
    def with_type(self, new_type: _DataTypeT) -> Field: ...
...
@overload
def list_(value_type: Field) -> ListType[_DataTypeT]: ...
@overload
...
@overload
def large_list(value_type: Field) -> LargeListType[_DataTypeT]: ...
@overload
def large_list(value_type: _DataTypeT) -> LargeListType[_DataTypeT]: ...
@overload
def list_view(value_type: Field) -> ListViewType[_DataTypeT]: ...
@overload
def list_view(value_type: _DataTypeT) -> ListViewType[_DataTypeT]: ...
@overload
def large_list_view(value_type: Field) -> LargeListViewType[_DataTypeT]: ...
@overload
